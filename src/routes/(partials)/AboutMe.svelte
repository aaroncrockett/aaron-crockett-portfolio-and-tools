...
<article class="mx-auto mb-4 card p-4 flex container flex-col gap-4 md:flex-row md:pb-4">
	...
	<div class="w-fullp-6 sm:order-2 md:w-1/2">
		...
		<p>
			I have always had a passion for creating things. During my younger years, I enjoyed tinkering
			with webpages. I also pursued my interests in painting, participated in design contests, and
			even played in a couple of garage bands.
		</p>
	</div>
</article>
