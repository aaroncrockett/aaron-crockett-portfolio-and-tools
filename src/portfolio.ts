...
export const portfolio: CustomThemeConfig = {
	...
	properties: {
	// =~= Theme Properties =~=
	"--theme-font-family-base": "brandon-grotesque, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
	"--theme-font-family-heading": "brandon-grotesque, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
	...
	// secondary | #8BBBE4 
	"--color-secondary-50": "238 245 251", // #eef5fb
	"--color-secondary-100": "232 241 250", // #e8f1fa
	"--color-secondary-200": "226 238 248", // #e2eef8
	"--color-secondary-300": "209 228 244", // #d1e4f4
	"--color-secondary-400": "174 207 236", // #aecfec
	"--color-secondary-500": "139 187 228", // #8BBBE4
	"--color-secondary-600": "125 168 205", // #7da8cd
	"--color-secondary-700": "104 140 171", // #688cab
	"--color-secondary-800": "83 112 137", // #537089
	"--color-secondary-900": "68 92 112", // #445c70
	// tertiary | #FFCB06 
